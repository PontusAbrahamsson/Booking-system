...
import { updateEmail, updatePassword, reauthenticateWithCredential, EmailAuthProvider, updateProfile, onAuthStateChanged } from "firebase/auth";
...
export default function Konto() {
  ...
  return (
    <>
              ...
              <>
                ...
                <ChangeUserInfoContainer>
                  <InfoItem>
                    ...
                    <span className='itemInfo'>Fredensvägen 1</span>
                  </InfoItem>
                  <InfoItem>
                ...
                <div className='bottomContainer'>
                  ...
                  <button className='removeAccountBtn'>Ta bort konto</button>
                </div>
              </>
            </UserInfoContainer>
          </Container>
      ...
      {/* <div>
        <br />
        <button onClick={() => setChangeEmailModal(true)}>Change email</button>
        ...
        {changeEmailModal === true &&
          <div>
            ...
            />
            <button onClick={reAuthenticate}>Change</button>
          </div>
        }
        <br />
        <br />
